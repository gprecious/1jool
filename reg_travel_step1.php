...
$_CSS[] = $yh['path'].'/css/reg_travel_step1.css';
...
<div class="contents-wrap container">
	<div class="contents-outer">
		<div class="contents-inner">
			...
			action="<?=$yh['path'] ?>/reg_travel_step2.php" method="post" accept-charset="utf-8">
				
				<div class="title row">
					<div class="col-xs-12">여행 등록하기</div>
				</div>
				<hr>
				...
				<div class="form-group row">
					<div class="col-xs-12 col-md-1 col-md-offset-2">
						<label for="pd_shortDesc">간단한 여행 설명</label>
					</div>
					<div class="col-xs-12 col-md-4">
				...
				<div class="form-group row">
					<div class="col-xs-12 col-md-1 col-md-offset-2">
						<label for="pd_price">여행 가격</label>
					</div>
					<div class="col-xs-12 col-md-4">
